<nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
    <div class="container">
        <a href="{{ route('home')}}" class="navbar-brand">
            ...
            <span class="brand-text font-weight-light">TJ88 SOETTA</span>
        </a>
            ...
            <ul class="navbar-nav mr-auto">
                ...
                @else
                    @if (Auth::user()->role_id == 2)
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (request()->segment(1) == 'informasi-gaji') ? 'active' : '' }}" href="{{ route('informasi-gaji') }}">Informasi Gaji</a>
                        </li>
                    @else
                        <li class="nav-item">
